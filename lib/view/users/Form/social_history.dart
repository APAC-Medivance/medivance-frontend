...
class _SocialHistoryFormState extends State<SocialHistoryForm> with SingleTickerProviderStateMixin {
  ...
  final TextEditingController _sanitationStatusController = TextEditingController();
  final TextEditingController _ventilationStatusController = TextEditingController();
  ...
  final TextEditingController _drinksPerWeekController = TextEditingController();
...
void initState() {
  ...
  Widget _buildSectionTitle(String title, IconData icon) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: lightBlue, width: 1),
        ),
      ),
      child: Row(
        children: [
